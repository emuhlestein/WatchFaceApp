...
import static com.example.android.sunshine.MainActivity.WEATHER_ID;
import static com.example.android.sunshine.MainActivity.WEATHER_MAXTEMP;
import static com.example.android.sunshine.MainActivity.WEATHER_MINTEMP;
...
public class NotificationUtils {
    ...
    public static void notifyUserOfNewWeather(Context context) {
        ...
        if (todayWeatherCursor.moveToFirst()) {
            ...
            float high = todayWeatherCursor.getFloat(INDEX_MAX_TEMP);
            float low = todayWeatherCursor.getFloat(INDEX_MIN_TEMP);

            sendData(context, low, high, weatherId);
    ...
    private static void sendData(Context context, float minTemp, float maxTemp, int weatherId) {
        ...
        localIntent.putExtra(WEATHER_ID, weatherId);
